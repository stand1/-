// pages/templateDetail/tempCard/tempCardA/tempCardA.js
...
Page({
  data: {
    ...
    imgs: "https://sixeco-redt.oss-cn-shenzhen.aliyuncs.com/redt-user-files/1602660085408redt_e300.png", // 背景图
    name: "段杨杨",
    position: "销售顾问",
    phone: "136 9482 4093",
  ...
  savePic: function () {
    ...
    wx.canvasToTempFilePath({
      ...
      success: function (res) {
        ...
        wx.navigateTo({
          url: '/pages/templateDetail/savedSuccess/savedSuccess?src='+tempFilePath
        })
        return
        if (tempFilePath !== "") {
          wx.hideLoading();
