// pages/templateDetail/tempCard/tempCardB/tempCardB.js
...
Page({
  data: {
    ...
    imgs: "https://sixeco-redt.oss-cn-shenzhen.aliyuncs.com/redt-user-files/1602817513827redt_e300.png", // 背景图
    name: "段杨杨",
    position: "销售顾问",
    phone: "136 9482 4093",
    phoneIcon: "https://sixeco-redt.oss-cn-shenzhen.aliyuncs.com/redt-user-files/1602814080187redt_e300.png",
    storeAddress: "广汽丰田深圳兆方店",
    storeAddressIcon: "https://sixeco-redt.oss-cn-shenzhen.aliyuncs.com/redt-user-files/1602814113345redt_e300.png",
    address: "广东省深圳市南山区丽水路1052号",
    addressIcon: "https://sixeco-redt.oss-cn-shenzhen.aliyuncs.com/redt-user-files/1602814126712redt_e300.png",
    iconWidth: 14,
    iconHeight: 14
  },
    ...
    wx.getSystemInfo({
      success: function (res) {
        that.setData({
          ...
          normalPageX: res.windowWidth * 0.3893,
          ...
          imgWidth: res.windowWidth * 0.448, //user图片宽度
          imgHeight: res.windowWidth * 0.5947, //user图片高度
          imgPageY: res.windowWidth * 0.3013, //user图片Y轴位置
          codeWidth: res.windowWidth * 0.192, //小程序码图片宽度
          codeHeight: res.windowWidth * 0.192, //小程序码图片高度
          codePageY: res.windowWidth * 1.12, //小程序码Y轴位置
          avatarPageY: res.windowWidth * 0.3893 + res.windowWidth * 0.5947 + 103, //地址IconY轴位置
          titlePageY: res.windowWidth * 0.3893 + res.windowWidth * 0.5947 + 115, //地址Y轴位置
          specPageY: res.windowWidth * 0.3893 + res.windowWidth * 0.5947 + 65, //手机Y轴位置
          pricePageY: res.windowWidth * 0.3893 + res.windowWidth * 0.5947, //姓名职位Y轴位置
          timePageY: res.windowWidth * 0.3893 + res.windowWidth * 0.5947 + 90 //门店地址Y轴位置
        });
      }
    });
  ...
  createNewImg: function (lineNum) {
    ...
    ctx.fillText(that.data.name, that.data.normalPageX-0.5, that.data.pricePageY+30);
    ctx.fillText(that.data.name, that.data.normalPageX, that.data.pricePageY-0.5+30);
    // 职位
    ctx.setFontSize(12);
    ctx.setFillStyle("#B5C8FF");
    ctx.fillText(
      that.data.position,
      that.data.normalPageX,
